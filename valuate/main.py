...
if __name__ == "__main__":
    ...
    predict = Predict()
    result = predict.predict(city='成都', model_detail_slug='m14877_ba', reg_year=2012, reg_month=3, deal_year=2018, deal_month=12, mile=12, ret_type='normal')
    # result = predict.predict_with_condition(condition_desc=gl.CONDITION_JSON, city='上海',model_detail_slug='96725_autotis', reg_year=2017, reg_month=6,deal_year=2018, deal_month=8, mile=4.5, ret_type='normal')
